...
using oyun1.Core.Effects;
using oyun1.Core.Localization;
using oyun1.Core.Settings;
using oyun1.ScreenManagers;
using oyun1.Screens;

namespace oyun1.Core
{
    /// <summary>
    ...
    public class oyun1Game : Game
    {
        ...
        private SettingsManager<oyun1Settings> settingsManager;

        // Manages leaderboard data for tracking high scores and achievements.
        private SettingsManager<oyun1Leaderboard> leaderboardManager;
        ...
        public oyun1Game()
        {
            ...
            settingsManager = new SettingsManager<oyun1Settings>(storage);
            Services.AddService(typeof(SettingsManager<oyun1Settings>), settingsManager);

            leaderboardManager = new SettingsManager<oyun1Leaderboard>(storage);
            Services.AddService(typeof(SettingsManager<oyun1Leaderboard>), leaderboardManager);
